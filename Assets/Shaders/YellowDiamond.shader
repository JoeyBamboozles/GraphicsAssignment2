    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            void frag (v2f i, out float4 oColor : SV_Target)
            {
                ...
                float3 yellow = float3(0.8, 0.8, 0.2); 
                float3 dark_yellow = float3(0.5, 0.5, 0.1);
                float3 color = lerp(yellow, dark_yellow, alternating_pattern);
